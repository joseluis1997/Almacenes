...
<div class="formulario__grupo" id="grupo__DescripcionRol">
    <label for="DescripcionRol" class="formulario__label">Descripcion
        <a class="colorSigno"  data-trigger="hover" href="#" data-toggle="popover" title="Modificar Descripcion Rol" data-content="La Modificacion de la Descripcion del Rol, Solo puede contener letras">?</a>
    </label>
    <div class="input-group">
        <textarea class="form-control formulario__input" id="DescripcionRol" name="descripcion" rows="3" >{{old('descripcion',$role->descripcion)}}</textarea>
        <i class="formulario__validacion-estado far fa-times-circle"></i>
    </div>
    <p class="formulario__input-error">
