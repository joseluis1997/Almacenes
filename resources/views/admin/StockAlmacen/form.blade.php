<!-- Grupo: Nombre Articulo -->
            <div class="formulario__grupo" id="grupo__articulo">
                <label for="articulo" class="formulario__label">Articulo</label>
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="#" id="articulo" placeholder="NOmbre del Articulo">
...
<!-- Grupo: fecha registro -->
            <div class="formulario__grupo" id="grupo__fecharegistro">
                ...
                <div class="formulario__grupo-input">
                    <input type="date" class="formulario__input" name="#" id="fecharegistro" placeholder="fecha registro de la compra">
                    <i class="formulario__validacion-estado far fa-times-circle"></i>
                </div>
                <p class="formulario__input-error">
                    El ci tiene que ser de 4 a 16 digitos y solo puede contener numeros, letras y guion bajo.
...
<!-- Grupo: Area -->
            <div class="formulario__grupo" id="grupo__area">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="#" id="NumeroOrdenTrabajo" placeholder="Area Solicitante">
                    <i class="formulario__validacion-estado far fa-times-circle"></i>                   
                </div>
                <p class="formulario__input-error">
                    El ci tiene que ser de 4 a 16 digitos y solo puede contener numeros, letras y guion bajo.
