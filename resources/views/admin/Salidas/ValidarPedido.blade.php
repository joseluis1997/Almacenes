...
{{-- Grupo: Area Solicitante --}}
    <div class="col-lg-6 col-sm-12 col-md-12 col-xs-12 formulario__grupo">
        ...
        <div class="form-group formulario__grupo-input">
            <select name="COD_AREA" id="area" class="form-control formulario__input selectpicker" data-live-search="true" data-size="3" disabled="">
                    <option value="{{ $pedido->Area->COD_AREA }}" selected="">{{ $pedido->Area->NOM_AREA }}</option>
            </select>
            
        </div>
          <p class="formulario__input-error">
          Seleccione el proveedor para el cual se validara la salidad del pedido..
          </p>
    </div>
